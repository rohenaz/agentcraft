...
export const CLIENTS: Record<ClientId, ClientCapabilities> = {
  ...
  'opencode': {
    ...
    supportedSkillEvents: new Set<SkillHookEvent>(),
    ...
    eventNotes: {
      ...
      PreToolUse: 'Skills load as prompt context, not tool calls',
      PostToolUse: 'Skills load as prompt context, not tool calls',
    },
  },
  'unknown': {
    id: 'unknown',
